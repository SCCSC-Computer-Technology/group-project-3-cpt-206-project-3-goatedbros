...
namespace Capstone2025_PantryPlatoon.Controllers
{
    public class CampusController : Controller
    {
        ...
        public CampusController(PantryPlatoonDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("CampusId,CampusName,Address")] Campus campus)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CampusId,CampusName,Address")] Campus campus)
        {
