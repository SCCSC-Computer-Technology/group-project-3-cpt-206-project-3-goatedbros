...
public partial class ApplicationDbContext : IdentityDbContext<ApplicationUser>
{
    ...
    public virtual DbSet<DocumentationUpload> DocumentationUploads { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.ToTable("VolunteerShifts");
            entity.HasKey(e => e.Id);
        });

        modelBuilder.Entity<VolunteerRequest>(entity =>
        {
            entity.ToTable("VolunteerRequests");
            entity.HasKey(e => e.Id);
        });
        ...
        modelBuilder.Entity<DocumentationUpload>(entity =>
        {
            entity.ToTable("DocumentationUploads");

            entity.HasKey(e => e.DocumentationUploadId);
